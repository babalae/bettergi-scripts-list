async function AutoFontaineLeyLine (settings) {
    ...
    var BIAOZZ = "lib/AutoFontaineLeyLine/assets/model/BIAOZ.bmp"
    ...
    if  (color == 2){ var DIMAIHUA = "lib/AutoFontaineLeyLine/assets/model/DIMAIHUA-huank.bmp";var DIMAIHUA2 = "lib/AutoFontaineLeyLine/assets/model/DIMAIHUA-lank.bmp";}
    else if (color == 1){var DIMAIHUA = "lib/AutoFontaineLeyLine/assets/model/DIMAIHUA-lank.bmp";var DIMAIHUA2 = "lib/AutoFontaineLeyLine/assets/model/DIMAIHUA-huank.bmp";}
    else{var DIMAIHUA = "lib/AutoFontaineLeyLine/assets/model/DIMAIHUA-lank.bmp";;var DIMAIHUA2 = "lib/AutoFontaineLeyLine/assets/model/DIMAIHUA-huank.bmp";}
    var DIMAIHUA3 = "lib/AutoFontaineLeyLine/assets/model/DIMAIHUA-da.bmp"
    var DIMAIHUA4 = "lib/AutoFontaineLeyLine/assets/model/DIMAIHUA-da2.bmp"
    var condensedResin = "lib/AutoFontaineLeyLine/assets/model/condensed_resin_count.png";
    var originalResin = "lib/AutoFontaineLeyLine/assets/model/original_resin_count.png";
    var fragileResin = "lib/AutoFontaineLeyLine/assets/model/fragile_resin_count.png";
    var momentResin = "lib/AutoFontaineLeyLine/assets/model/moment_resin_count.png";
    var cilun = "lib/AutoFontaineLeyLine/assets/model/cilun.bmp";

    var resinImages = [
        "lib/AutoFontaineLeyLine/assets/model/zero.png",
        "lib/AutoFontaineLeyLine/assets/model/one.png",
        "lib/AutoFontaineLeyLine/assets/model/two.png",
        "lib/AutoFontaineLeyLine/assets/model/three.png",
        "lib/AutoFontaineLeyLine/assets/model/four.png",
        "lib/AutoFontaineLeyLine/assets/model/five.png"
    ];
    ...
    const folder1 = 'lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线1 厄里那斯/';
    const folder2 = 'lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线2 秋分山西侧锚点左下/';
    const folder3 = 'lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线3 秋分山西侧锚点右/';
    const folder4 = 'lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线4 柔灯港上锚点/';
    const folder5 = 'lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线5 新枫丹科学院左锚点/';
    const folder6 = 'lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线6 芒索斯山东麓/';
        ...
        for (let i = 0; i < selectedPath.length; i += 2){
            ...
            if(SMODEL){
                if (!Lastexecution || (position.line==1 && (i+position.flower*2-2)==8)) {                        
                    if(position.line==2 && (i+position.flower*2-2)==8 && Lastexecution){                       
                        await pathingScript.runFile("lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线2 秋分山西侧锚点左下/线路修复/枫丹地脉花-路线2 秋分山西侧锚点左下-5：秋分山左左下下1-线路修复.json");}
                    else{ 
            ...
            if (await VeinEntrance()){ 
                ...
                if(position.line==2 && (i+position.flower*2-2)==8){   
                    ...
                    await pathingScript.runFile("lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线2 秋分山西侧锚点左下/线路修复/枫丹地脉花-路线2 秋分山西侧锚点左下-5：秋分山左左下下_特殊处理.json");
                }else if (position.line==6 && (i+position.flower*2-2)==2){
                    await pathingScript.runFile("lib/AutoFontaineLeyLine/assets/枫丹地脉花-路线6 芒索斯山东麓/线路修复/枫丹地脉花-路线6 芒索斯山东麓-2：锚点右1_特殊处理.json");
                }
