const ExpeditionIconRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectExpedition Icon.png"), 1260, 200, 70, 700);
const ClaimDailyCommissionRewardIconRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectClaim Daily Commission Reward Icon.png"), 1260, 200, 70, 700);
const ExpeditionClaimButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectExpedition Claim Button.png"), 40, 980, 60, 80);
const EncounterPointsConfirmButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectConfirm Button.png"), 500, 500, 900, 300);
const HideUIButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectHide UI Button.png"), 0, 0, 500, 100);

const AdventurerHandbookButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectAdventurer Handbook Button.png"), 100, 300, 700, 700);
const RewardClaimedRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectReward Claimed.png"), 400, 800, 300, 100);

const MailButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectMail Button.png"), 0, 300, 100, 600);

const BattlePassButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectBattle Pass Button.png"), 100, 300, 700, 700);
const SelectedTaskButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectSelected Task Button.png"), 800, 0, 300, 90);
const TaskButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectTask Button.png"), 800, 0, 300, 90);
const SelectedGnosticHymnButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectSelected Gnostic Hymn Button.png"), 800, 0, 300, 90);
const GnosticHymnButtonRo = RecognitionObject.TemplateMatch(file.ReadImageMatSync("Assets/RecognitionObjectGnostic Hymn Button.png"), 800, 0, 300, 90);
...
async function claimAdventurersGuildTasks(uname, uid) {
    ...
    if (ClaimDailyCommissionRewardIcon.isExist()) {
        ...
        let EncounterPointsConfirmButton = ro4.find(EncounterPointsConfirmButtonRo);
        ro4.dispose();
        ...
        if (HideUIButton.isExist()) {
            ...
            msg = "已领取「每日委托」奖励";
            if (settings.adventurersGuildCommissionNotice) {
...
async function dailyRewardNotice(uname, uid) {
    ...
    if (AdventurerHandbookButton.isExist()) {
        ...
        msg += `\n当前原初树脂${originalResin}，剩余历练点${encounterPoints}`;
        log.info(msg);
