async function AutoFontaineLeyLine (settings) {
    ...
    var BIAOZZ = "User/JsScript/AutoFontaineLeyLine/assets/model/BIAOZ.bmp"
    ...
    log.warn(`全自动枫丹地脉花: v4.0 - ${SHUV}.${color}.${rawTimes}`);//调试LOG
    log.warn(`使用树脂类型数量：${rewards.length}`);
    log.warn(`使用树脂顺序：${golbalRewardText.join(" ->")}`); 

    if  (color == 2){ var DIMAIHUA = "User/JsScript/AutoFontaineLeyLine/assets/model/DIMAIHUA-huank.bmp";var DIMAIHUA2 = "User/JsScript/AutoFontaineLeyLine/assets/model/DIMAIHUA-lank.bmp";}
    else if (color == 1){var DIMAIHUA = "User/JsScript/AutoFontaineLeyLine/assets/model/DIMAIHUA-lank.bmp";var DIMAIHUA2 = "User/JsScript/AutoFontaineLeyLine/assets/model/DIMAIHUA-huank.bmp";}
    else{var DIMAIHUA = "User/JsScript/AutoFontaineLeyLine/assets/model/DIMAIHUA-lank.bmp";;var DIMAIHUA2 = "User/JsScript/AutoFontaineLeyLine/assets/model/DIMAIHUA-huank.bmp";}
    var DIMAIHUA3 = "User/JsScript/AutoFontaineLeyLine/assets/model/DIMAIHUA-da.bmp"
    var DIMAIHUA4 = "User/JsScript/AutoFontaineLeyLine/assets/model/DIMAIHUA-da2.bmp"
    var condensedResin = "User/JsScript/AutoFontaineLeyLine/assets/model/condensed_resin_count.png";
    var originalResin = "User/JsScript/AutoFontaineLeyLine/assets/model/original_resin_count.png";
    var fragileResin = "User/JsScript/AutoFontaineLeyLine/assets/model/fragile_resin_count.png";
    var momentResin = "User/JsScript/AutoFontaineLeyLine/assets/model/moment_resin_count.png";
    var cilun = "User/JsScript/AutoFontaineLeyLine/assets/model/cilun.bmp";

    var resinImages = [
        "User/JsScript/AutoFontaineLeyLine/assets/model/zero.png",
        "User/JsScript/AutoFontaineLeyLine/assets/model/one.png",
        "User/JsScript/AutoFontaineLeyLine/assets/model/two.png",
        "User/JsScript/AutoFontaineLeyLine/assets/model/three.png",
        "User/JsScript/AutoFontaineLeyLine/assets/model/four.png",
        "User/JsScript/AutoFontaineLeyLine/assets/model/five.png"
    ];
    ...
    const folder1 = 'User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线1 厄里那斯/';
    const folder2 = 'User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线2 秋分山西侧锚点左下/';
    const folder3 = 'User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线3 秋分山西侧锚点右/';
    const folder4 = 'User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线4 柔灯港上锚点/';
    const folder5 = 'User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线5 新枫丹科学院左锚点/';
    const folder6 = 'User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线6 芒索斯山东麓/';
        ...
        for (let i = 0; i < selectedPath.length; i += 2){
            ...
            if(SMODEL){
                if (!Lastexecution || (position.line==1 && (i+position.flower*2-2)==8)) {                        
                    if(position.line==2 && (i+position.flower*2-2)==8 && Lastexecution){                       
                        await pathingScript.runFile("User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线2 秋分山西侧锚点左下/线路修复/枫丹地脉花-路线2 秋分山西侧锚点左下-5：秋分山左左下下1-线路修复.json");}
                    else{ 
            ...
            if (await VeinEntrance()){ 
                ...
                if(position.line==2 && (i+position.flower*2-2)==8){   
                    ...
                    await pathingScript.runFile("User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线2 秋分山西侧锚点左下/线路修复/枫丹地脉花-路线2 秋分山西侧锚点左下-5：秋分山左左下下_特殊处理.json");
                }else if (position.line==6 && (i+position.flower*2-2)==2){
                    await pathingScript.runFile("User/JsScript/AutoFontaineLeyLine/assets/枫丹地脉花-路线6 芒索斯山东麓/线路修复/枫丹地脉花-路线6 芒索斯山东麓-2：锚点右1_特殊处理.json");
                }
