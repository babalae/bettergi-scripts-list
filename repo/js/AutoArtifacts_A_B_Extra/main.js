(async function () {
    ...
    const pathingA = [
        "狗粮-璃月-沉玉谷上谷-东-2个.json",
        "狗粮-璃月-沉玉谷南陵-3个（另一个太远）.json",
        "（恢复）狗粮-璃月-沉玉谷南陵.json",
        "狗粮-璃月-珉林-北-5个.json",
        "狗粮-璃月-珉林-东北-9个.json",
        "狗粮-璃月-珉林-奥藏山南-3个.json",
        "狗粮-璃月-珉林-绝云间-3个.json",
        "狗粮-璃月-珉林-天道谷-3个.json",
        "（恢复）狗粮-璃月-琼玑野.json",
        "狗粮-璃月-琼玑野-绿华池-3个.json",
        "狗粮-璃月-碧水源-望舒客栈-1个.json",
        "狗粮-璃月-碧水源-盐中之地-3个.json",
        "狗粮-璃月-碧水源-轻策庄-3个.json",
        "狗粮-须弥-护世森-卡萨扎莱宫南-2个.json",
        "狗粮-须弥-须弥城-3个（有一个剧烈摇晃，不拿）.json",
        "狗粮-须弥-道成林-化城郭-西-3个.json",
        "狗粮-须弥-二净甸-七天神像-4个(重兵把守，其余不拿).json",
        "（恢复）狗粮-须弥-二净甸.json",
        "狗粮-须弥-二净甸-觉王之殿南-6个.json",
        "狗粮-须弥-失落的苗圃-南-8个.json",
        "狗粮-须弥-上风蚀地-东北营地-2个.json",
        "狗粮-须弥-下风蚀地-阿如村-4个.json",
        "狗粮-须弥-下风蚀地-阿如村-北-1个.json",
        "狗粮-须弥-千壑沙地-圣显厅西-3个.json",
        "（恢复）狗粮-须弥-千壑沙地.json",
        "狗粮-须弥-千壑沙地-塔尼特露营地-3个.json",
        "狗粮-须弥-千壑沙地-神的棋盘-1个（只拿前一个）.json",
        "狗粮-须弥-浮罗囿-甘露花海北-4个.json",
        "狗粮-纳塔-坚岩隘谷-回声之子南-7个.json",
