(async function () {
    ...
    const resolutionMap = {
        ...
        "5120x2880": [5120, 2880, 1],
        "7680x4320": [7680, 4320, 1]
    };
    ...
    async function main() {
        ...
        // 设置游戏分辨率和缩放比例
        let scale = scaleMap[settings.display_scaling || "100%"];
        const [width, height, resolutionScale] = resolutionMap[settings.game_metrics] || [1920, 1080, scale];
        setGameMetrics(width, height, resolutionScale);
