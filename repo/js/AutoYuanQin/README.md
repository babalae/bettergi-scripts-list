...
1. 点击运行开始播放音乐
- tips:
  - `AutoYuanQin/tools/StaffMaker`文件夹下的制谱软件(`五线谱制谱器.html`)为早期制谱用软件
  - 现在有更自动化的`AutoYuanQin/tools/MIDI翻谱器.html`提供自动的MIDI文件转*AutoYuanQin*格式的乐谱
  - `AutoYuanQin/tools/StaffMaker`目录下有文档供曲谱制作人阅读
...
## 五线谱翻谱器
1. 五线谱翻谱器位于`AutoYuanQin/tools/StaffMaker/五线谱制谱器.html`,请使用浏览器打开
...
## 曲谱制作解答
1. `/tools/StaffMaker/五线谱注解.png` 包含了五线谱(高音区和低音区)对应的3组键盘键位(相邻的红蓝大写字母为一组, 每组音域为三个八度)
1. 有不懂的地方请在 `/tools/StaffMaker/example.json` 内找, 这个谱子内包含了该脚本的五线谱相关的所有功能
...
**注意**：以上代码中仅 :  右侧的**双引号内**的部分可以更改, 具体的曲谱格式请参考 `/tools/StaffMaker` 路径下的 `example.json`
...
表示按下A键, A键视作四分音符
<div align="center">
  <img src="tools/StaffMaker/四分音符示例.png"/>
  <p>四分音符示例</p>
</div>
...
表示**装饰音·倚音**  
<div align="center">
  <img src="tools/StaffMaker/装饰音·倚音示例.png"/>
  <p>装饰音·倚音示例</p>
</div>
...
另外, 连音内支持和弦
<div align="center">
  <img src="tools/StaffMaker/三连音示例.png"/>
  <p>三连音示例</p>
</div>
...
表示一个**五连音**, 同理也可以是**N连音**
<div align="center">
  <img src="tools/StaffMaker/五连音示例.png"/>
  <p>五连音示例</p>
</div>
...
<div align="center">
  <img src="tools/StaffMaker/三连音连音线示例.png"/>
  <p>三连音连音线示例</p>
</div>
...
<div align="center">
  <img src="tools/StaffMaker/六连音连音线示例.png"/>
  <p>六连音连音线示例</p>
</div>
...
表示一个**休止符**
<div align="center">
  <img src="tools/StaffMaker/四分休止符示例.png"/>
  <p>四分休止符示例</p>
</div>
...
表示一个**附点四分音符**
<div align="center">
  <img src="tools/StaffMaker/附点四分音符示例.png"/>
  <p>附点四分音符示例</p>
</div>
