(async function () { // 鱼饵合成上限[]、鱼饵原料数不为2时可能出错[]、NPC的CD记录[]，OCR仍有识别错误的可能性，例如1111识别成11
    ...
    const bait_list = ["果酿饵", "赤糜饵", "蠕虫假饵", "飞蝇假饵", "甘露饵", "酸桔饵", "维护机关频闪诱饵", "澄晶果粒饵", "温火饵", "槲梭饵", "清白饵", "闪烁饵"]
    const material_msg = {
        ...
        "雪鱼王之杖": {"炭灰雪圆鳍":20, "赤甜星花鱼": 20, "青仙星花鱼": 20},
    ...
    const fish_msg = { // [DEBUG] 从AEscoffier_main补充数据
        ...
        "青仙星花鱼": {"bait": "闪烁饵", "num": 0},
        "赤甜星花鱼": {"bait": "闪烁饵", "num": 0},
        "虹晶星花鱼": {"bait": "闪烁饵", "num": 0},
        "奶油雪圆鳍": {"bait": "闪烁饵", "num": 0},
        "炭灰雪圆鳍": {"bait": "闪烁饵", "num": 0},
        "月光雪圆鳍": {"bait": "闪烁饵", "num": 0}
