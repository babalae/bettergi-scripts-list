...
| dailyRooms             | 每日奇域关卡关键词或关卡GUID     | 逗号分隔                                                           | 24429042323,28644538672,33030477060                             |
| dailyPlaybacks         | 每日通关回放文件随机池           | 同一关卡逗号分隔，不同关卡分号分隔，自行录制拷贝到assets/playbacks | 通关回放1.json,通关回放2.json;30秒按1通关.json;30秒按4通关.json |
