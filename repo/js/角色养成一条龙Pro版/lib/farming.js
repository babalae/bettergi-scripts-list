// 材料刷取模块
var Farming = {
    getTalentBook: async function(materialName, bookRequireCounts, characterName, uid) {
        while (1) {
    ...
    getWeaponMaterial: async function(materialName, weaponRequireCounts, characterName, uid) {
        while (1) {
            ...
            if (afterStamina >= 20) {
                try {
                    ...
                    if (res > 0) {
                        ...
                        await TaskManager.addCompletedTask("wepon", materialName, weaponRequireCounts, characterName, uid);
                        return;
                    }
                } catch (error) {
                    if (error.message && error.message.includes("检测到复苏界面")) {
    ...
    getBossMaterial: async function(bossName, bossRequireCounts, characterName, uid) {
        while (1) {
