...
**若脚本有问题，可[点击此处进行反馈](https://github.com/babalae/bettergi-scripts-list/issues/new?template=bug_report.yml&script-name=CD-Aware-AutoGather:2.8.0&additional-info=保留此行以便通知作者:%20@Patrick-Ze%0A%0A---%0A)**
