...
var MobPuller = {
    ...
    findLamp: async function() {
      ...
      const lampRo = RecognitionObject.TemplateMatch(
        file.ReadImageMatSync('assets/Laim/Recognition/DENG.png'),
        1160, 540,                       // x, y
      ...
      const xietiaoRo = RecognitionObject.TemplateMatch(
        file.ReadImageMatSync('assets/Laim/Recognition/血条.png'),
        0, 0,
        genshin.width,
    ...
    captureCrystalfly: async function(locationName, istp = true, x = 253.3994140625, y = 1285.4423828125) {
        ...
        const filePath = `assets/Laim/pathing/KeyMouseScript/${locationName}.json`;
