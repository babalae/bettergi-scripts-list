 ...
 * ========================================================= */
            ...
            eval(file.readTextSync("lib/Laim/lib/CharacterRotator.js"));
eval(file.readTextSync("lib/Online/Multiplayer.js"));

        xietiao = RecognitionObject.TemplateMatch(
            file.ReadImageMatSync('assets/Laim/Recognition/血条.png'), 600, 0, 600, 120);
        Shui = RecognitionObject.TemplateMatch(
            file.ReadImageMatSync('assets/Laim/Recognition/Shui.png'), 740, 90, 100, 50);
var MobFallAttack = {

    /* ---------- 1. 委托前准备（可扩展吃药/换队） ---------- */
    Run01: async function () {
        log.info('[MobFallAttack] 开始射击执行前准备');
        // TODO: 换角色、吃药、开盾等
        log.info('[MobFallAttack] 前准备完成');
    },
...
// await genshin.Tp(3032.96875, 3732.70);
    ...
    dispatcher.addTimer(new RealtimeTimer("AutoPick", { forceInteraction: true }));
            ...
            // await sleep(1200);
            // const filePath = 'assets/Laim/跳加下落1.json';
            //         await keyMouseScript.runFile(filePath); // 跳+下落
