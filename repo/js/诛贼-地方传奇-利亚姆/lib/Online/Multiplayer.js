...
var Multiplayer = {
    ...
    WHEEL_SCROLL_JSON_PATH: "assets/scripts/滚轮下翻.json",
    ...
    detectPlayerCount: async function() {
        ...
        const region = captureGameRegion();
            const joinResult = captureGameRegion().find(RecognitionObject.TemplateMatch(file.ReadImageMatSync(`assets/ui/a.png`), 0, 0, 1920, 1080));
