...
(async function () {
    try {
        ...
        const routeOrder = settings.routeOrder || "效率顺序"; // 获取路线顺序选择，默认使用效率顺序
   ...
   { taskName: '薄荷C30-稻妻-海祇岛-曚云神社', mintCount: 5 },
    ...
    {taskName: '薄荷E03-枫丹-厄里那斯2', mintCount: 8},
    {taskName: '薄荷E04-枫丹-厄里那斯3', mintCount: 7},
    {taskName: '薄荷E05-枫丹-厄里那斯4', mintCount: 4},
    {taskName: '薄荷E06-枫丹-厄里那斯5', mintCount: 5},
    {taskName: '薄荷E07-枫丹-秋分山西侧', mintCount: 5},
    {taskName: '薄荷E08-枫丹-秋分山东侧', mintCount: 6},
    {taskName: '薄荷E09-枫丹-枫丹廷1', mintCount: 6},
    ...
    {taskName: '薄荷F16-纳塔-花语会6', mintCount: 4}
        ...
        let orderedTasks = [];
        if (routeOrder === "效率顺序") {
            orderedTasks = efficiencyTasks;
        } else if (routeOrder === "地图顺序") {
            orderedTasks = mapOrderTasks;
        }
        ...
        if (!isRefresh) {
            try {
                ...
                if (isNaN(currentIndex) || currentIndex < 0 || currentIndex >= orderedTasks.length) {
                    currentIndex = 0;
                }
            } catch (error) {
                currentIndex = 0;
